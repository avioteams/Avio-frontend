    ...
    >
      <div className="flex justify-between items-center">
        ...
        <section className="hidden lg:flex gap-2">
          <Button className="text-secondary bg-secondary-foreground rounded-full px-5 xl:px-7 py-4 xl:py-5 hover:scale-105 transition-transform text-sm xl:text-base">
            Login
          </Button>
          <Button className="bg-[#e30101] text-white rounded-full px-5 xl:px-7 py-4 xl:py-5 hover:scale-105 hover:shadow-[0_0_20px_rgba(227,1,1,0.4)] transition-all text-sm xl:text-base">
            Connect Wallet
          </Button>
        </section>
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden absolute top-full left-0 right-0 bg-[#121212]/98 backdrop-blur-lg border-t border-white/10 p-6 space-y-4 animate-in slide-in-from-top duration-200">
          ...
          <div className="flex flex-col gap-2 pt-4 border-t border-white/10">
            <Button className="text-secondary bg-secondary-foreground rounded-full w-full py-5">
              Login
            </Button>
            <Button className="bg-[#e30101] hover:bg-[#c10101] text-white rounded-full w-full py-5 hover:shadow-[0_0_20px_rgba(227,1,1,0.4)] transition-all">
              Connect Wallet
            </Button>
          </div>
        </div>
